...
for i=1:length(time)-1
    ...
    newS1p = SSp * neweff0q;
    newS1q = SSq * neweff0p;
    [Sourcetermp,Sourcetermq]=SourceTerm(newtime,X,Xdual,MMp,Sp,Sq,MMq,N,option);
    ...
    [Sourcetermp,Sourcetermq]=SourceTerm(newtime1,X,Xdual,MMp,Sp,Sq,MMq,N,option);
    newS1p=newS1p + Sourcetermp;
    newS1q=newS1q + Sourcetermq;
    k2p=MMp1 * newS1p;
    k2q=MMq1 * newS1q;
    ...
    [Sourcetermp,Sourcetermq]=SourceTerm(newtime2,X,Xdual,MMp,Sp,Sq,MMq,N,option);
    newS1p=newS1p + Sourcetermp;
    newS1q=newS1q + Sourcetermq;
    k3p=MMp1 * newS1p;
    k3q=MMq1 * newS1q;
    ...
    [Sourcetermp,Sourcetermq]=SourceTerm(newtime3,X,Xdual,MMp,Sp,Sq,MMq,N,option);
    newS1p=newS1p + Sourcetermp;
    newS1q=newS1q + Sourcetermq;
    k4p=MMp1 * newS1p;
    k4q=MMq1 * newS1q;
